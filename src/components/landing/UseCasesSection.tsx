...
export const UseCasesSection: React.FC = () => {
  ...
  return (
    <section id="use-cases" className="py-20 sm:py-24 bg-white border-b border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {useCases.map((item) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <div className="text-[11px] font-semibold text-slate-500 uppercase tracking-wide">{item.badge}</div>
        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-slate-50/70 border border-slate-200 shadow-card grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-6 space-y-5">
            <span className="px-3 py-1 rounded-full text-xs font-semibold bg-brand-50 text-brand-600 border border-brand-200">
              {currentCase.badge}
            </span>
          ...
          <div className="lg:col-span-6 bg-white rounded-2xl border border-slate-200 p-5 space-y-3.5 shadow-sm">
            <div className="flex items-center justify-between text-[11px] border-b border-slate-100 pb-2">
              <span className="text-slate-400 font-bold uppercase tracking-wider">VERIFIED CITATION DEMO</span>
              <span className="text-emerald-600 font-bold">100% CITED</span>
            </div>

            {/* Prompt */}
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200/80 text-xs text-slate-700">
              <span className="text-[10px] font-bold text-brand-600 uppercase block mb-1">TEAM QUERY:</span>
              &ldquo;{currentCase.sampleQuestion}&rdquo;
            </div>

            {/* Answer */}
            <div className="bg-white border border-slate-200 p-4 rounded-xl space-y-2.5 shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
