      ...
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-slate-200 p-6 sm:p-8 text-slate-900 relative">
        ...
        {submitted ? (
          ...
          <div>
            ...
            <h2 className="text-xl font-bold text-slate-900">Schedule a 15-Min Live Demo</h2>
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-3.5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-xs sm:text-sm text-slate-900 outline-none focus:ring-2 focus:ring-brand-500"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full py-3 bg-brand-500 hover:bg-brand-600 text-white font-bold text-xs sm:text-sm rounded-xl shadow-md transition-all flex items-center justify-center gap-2 mt-2"
              >
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-400">
              ...
              <Link href="/dashboard" onClick={onClose} className="font-bold text-brand-600 hover:underline">
                Or enter Instant Sandbox →
              </Link>
            </div>
          </div>
        )}
