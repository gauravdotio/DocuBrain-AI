      ...
      <aside className="w-full md:w-64 bg-ink-900 border-r border-ink-800 flex flex-col justify-between shrink-0 z-30">
        <div>
          ...
          <div className="h-16 px-5 border-b border-ink-800 flex items-center justify-between">
            ...
            <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-amberAccent-500/15 text-amberAccent-400 border border-amberAccent-500/30 font-semibold">
              STUDIO
            </span>
          </div>
          ...
          <div className="p-3 border-b border-ink-800/80">
            <div className="p-2.5 rounded-xl bg-ink-850 border border-ink-700/80 text-left">
              ...
              <div className="flex items-center justify-between mt-1">
                ...
                <span className="w-2 h-2 rounded-full bg-emerald-400 shadow-glowAmber shrink-0" />
              </div>
            </div>
          </div>
              ...
              return (
                <Link
                  ...
                  className={`flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-semibold transition-all ${
                    isActive
                      ? "bg-ink-800 text-amberAccent-400 border border-amberAccent-500/40 shadow-glowAmber"
                      : "text-ink-400 hover:text-white hover:bg-ink-850 border border-transparent"
                  }`}
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    <Icon className={`w-4 h-4 ${isActive ? "text-amberAccent-400" : "text-ink-400"}`} />
                  ...
                  {item.badge && (
                    <span
                      className={`text-[10px] font-mono px-1.5 py-0.5 rounded ${
                        isActive
                          ? "bg-amberAccent-500/20 text-amberAccent-400 font-bold border border-amberAccent-500/30"
        ...
        <div className="p-3 border-t border-ink-800 bg-ink-900/60 space-y-2">
          <div className="flex items-center justify-between p-2 rounded-xl bg-ink-850 border border-ink-700/80">
            <div className="flex items-center gap-2 min-w-0">
              <div className="w-7 h-7 rounded-lg bg-amberAccent-500/20 text-amberAccent-400 border border-amberAccent-500/30 font-bold text-xs flex items-center justify-center shrink-0">
          ...
          <div className="px-1 text-center">
            <Link
              href="/"
              className="text-[11px] font-medium text-ink-400 hover:text-amberAccent-400 flex items-center justify-center gap-1 transition-colors"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <header className="h-16 px-6 border-b border-ink-800 bg-ink-900 flex items-center justify-between shrink-0 z-20">
          <div className="flex items-center gap-2 text-xs text-ink-400">
            ...
            <span>/</span>
            <span className="capitalize text-amberAccent-400 font-mono">
              {pathname === "/dashboard"
                ? "Live RAG Workspace"
          ...
          <div className="flex items-center gap-3">
            {/* Rate Limit Badge */}
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-amberAccent-500/30 bg-ink-850 text-amberAccent-400 text-xs font-mono">
