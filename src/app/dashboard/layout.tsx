      ...
      <aside className="w-full md:w-64 bg-white border-r border-slate-200 flex flex-col justify-between shrink-0 z-30">
        <div>
          ...
          <div className="h-16 px-5 border-b border-slate-200 flex items-center justify-between">
            ...
            <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-brand-50 text-brand-600 border border-brand-200 font-semibold">
              STUDIO
            </span>
          </div>
          ...
          <div className="p-3 border-b border-slate-100">
            <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200 text-left">
              ...
              <div className="flex items-center justify-between mt-1">
                ...
                <span className="w-2 h-2 rounded-full bg-emerald-500 shadow-sm shrink-0" />
              </div>
            </div>
          </div>
                  ...
                  {item.badge && (
                    <span
                      className={`text-[10px] font-mono px-1.5 py-0.5 rounded ${
                        isActive
                          ? "bg-brand-100 text-brand-700 font-bold border border-brand-200"
        ...
        <div className="p-3 border-t border-slate-100 bg-slate-50/60 space-y-2">
          <div className="flex items-center justify-between p-2 rounded-xl bg-white border border-slate-200 shadow-xs">
            <div className="flex items-center gap-2 min-w-0">
              <div className="w-7 h-7 rounded-lg bg-brand-50 text-brand-600 border border-brand-200 font-bold text-xs flex items-center justify-center shrink-0">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <header className="h-16 px-6 border-b border-slate-200 bg-white flex items-center justify-between shrink-0 z-20">
          ...
          <div className="flex items-center gap-3">
            {/* Rate Limit Badge */}
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-brand-200 bg-brand-50 text-brand-700 text-xs font-semibold shadow-xs">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
              <span>{rateLimit ? rateLimit.remaining : 10}/10 Queries</span>
              <span className="text-[10px] text-slate-400 font-normal hidden sm:inline">• Upstash Guardrail</span>
            </div>

            <Link
              href="/"
              className="hidden sm:inline-flex items-center gap-1 px-3 py-1.5 text-xs font-semibold text-slate-700 hover:text-slate-900 bg-white hover:bg-slate-50 border border-slate-200 rounded-lg transition-colors shadow-xs"
            >
